...
module.exports.compile = function (spec, _extraDefinitions) {
  return build(spec, _extraDefinitions).compile();
}

module.exports.build = function(spec, _extraDefinitions) {
 return build(spec, _extraDefinitions); 
};

var build = function(spec, _extraDefinitions){
